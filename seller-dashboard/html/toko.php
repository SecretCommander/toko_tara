...
$result = detail_data($_SESSION['penjual_id']); 
                ...
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="col-lg-12 col-md-4 d-none d-lg-none d-xl-block">
                        <div class="row">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-4 d-block d-sm-none">
                        <div class="">
                          <div class="card-body">
                            <h6>Gambar Toko</h6>
                            <img src="" alt="" class="img">
